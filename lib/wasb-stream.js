 ...
 *
 *
 * @param {String} href 		URL completa con que desea almacenarse el 
 * fichero, incluyendo el propio `basename` de dicho fichero. Por ejemplo, 
 * <service>.blob.core.windows.net/<container>/<key>,
 * donde **key** no solo incluye el `dirname` sino tambien el `basename`
 */
